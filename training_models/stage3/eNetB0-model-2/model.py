...
dir_name = "training_models/eNetB0-model-2/"
...
class SpatialAttention(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.conv = layers.Conv2D(1, kernel_size=5, padding="same", activation="sigmoid")
...
def create_model(num_classes=7):
    ...
    # Unfreeze the last 10% of layers
    total_layers = len(base_model.layers)
    trainable_layers = int(total_layers * 0.1)
...
if __name__ == "__main__":    
    ...
    batch_size, epoch_size, learning_rate = 256, 100, 5e-4
    ...
    history = train_model(model, train_dataset, val_dataset, num_epochs=epoch_size, learning_rate=learning_rate, log_file= dir_name+"training_log.csv")
